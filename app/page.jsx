   ...
   <div>
    <div className="flex h-screen">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 pb-8 bg-[#292a2d] text-white relative " >
        ...
        (
          // important
        <div className="mb-7 relative flex flex-col items-center justify-start w-full mt-20 max-h-screen overflow-y-auto  " ref={containerRef}  >
          ...
          ))}
          {
            isLoading && (
              <div className="flex gap-4 max-w-3xl w-full py-3">
                ...
                <div className="loader flex jusitfy-center items-center gap-1">
